...
class todo:
    def __init__(self,root):
        ...
        self.label1=Label(self.root,text="TO-DO-LIST",font=("ariel",25,"bold"), width=10,bd=5,bg="aquamarine3",fg="black")
        self.label1.pack(side="top",fill=BOTH)


        self.label2=Label(self.root,text="ADD TASK",font=("ariel",18,"bold"), width=10,bd=5,bg="aquamarine3",fg="black")
        self.label2.place(x=40,y=55)

        self.label3=Label(self.root,text="TASKS",font=("ariel",18,"bold",), width=10,bd=5,bg="aquamarine3",fg="black")
